---
key: "DEFIS.CONSDECREC144"
family: "integra-sn"
systemId: "DEFIS"
serviceId: "CONSDECREC144"
version: "1.0"
...
Consulta o pdf de uma declaração específica e seu recibo de entrega.

## Identificação

| Propriedade | Valor |
| --- | --- |
| Chave | `DEFIS.CONSDECREC144` |
| Família | `integra-sn` |
...
| --- | --- | --- | --- | --- | --- |
| Dados de Entrada | idDefis | Number | — | — | Id Defis de uma declaração contida entre o primeiro ano após decadência e o ano atual |
...
| Dados de Saída | dados | String | — | — | Estrutura de dados de retorno, contendo uma lista com o objeto UltimaDeclaracao. |
| Dados de Saída — Objeto: UltimaDeclaracao | recibo | String | — | — | PDF do recibo no formato base 64 |
| Dados de Saída — Objeto: UltimaDeclaracao | declaracao | String | — | — | PDF da declaração no formato base 64 |
...
- **info / official-example-large-payload-redacted:** Uma carga Base64 extensa foi substituída por marcador para manter a base adequada a contexto de IA. ([fonte](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-sn/defis/exemplos/retorno_consultar_declaracaorecibo/))
- **warning / official-example-invalid-json:** O bloco oficial aparenta ser JSON, mas não pôde ser interpretado sem inferência. ([fonte](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-sn/defis/exemplos/retorno_consultar_declaracaorecibo/))

## Proveniência

- [Documentação oficial SERPRO](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-sn/defis/servicos/consultar_declaracaorecibo/)
- [Documentação oficial SERPRO](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-sn/defis/exemplos/retorno_consultar_declaracaorecibo/)

- Última atualização informada pela fonte: 10 de abril de 2026 12:33:28 UTC
- Conteúdo coletado em: 2026-09-14T14:55:05.806Z
- SHA-256 semântico: `6e3d72b61b35376ad13d968e99a9619b4c25b9192f4ca1e4a8f6d444631c654a`
