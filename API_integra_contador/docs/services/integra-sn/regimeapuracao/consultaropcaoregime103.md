---
key: "REGIMEAPURACAO.CONSULTAROPCAOREGIME103"
family: "integra-sn"
systemId: "REGIMEAPURACAO"
serviceId: "CONSULTAROPCAOREGIME103"
version: "1.0"
...
Consultar a opção pelo Regime de Apuração de Receitas

## Identificação

| Propriedade | Valor |
| --- | --- |
| Chave | `REGIMEAPURACAO.CONSULTAROPCAOREGIME103` |
| Família | `integra-sn` |
...
| --- | --- | --- | --- | --- | --- |
| Dados de Entrada — Objeto Dados: | anoCalendario | Number | SIM | — | Ano Opção |
...
- **info / official-example-large-payload-redacted:** Uma carga Base64 extensa foi substituída por marcador para manter a base adequada a contexto de IA. ([fonte](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-sn/regime/exemplos/retorno_consultar_opcao/))

## Proveniência

- [Documentação oficial SERPRO](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-sn/regime/servicos/consultar_opcao/)
- [Documentação oficial SERPRO](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-sn/regime/exemplos/retorno_consultar_opcao/)

- Última atualização informada pela fonte: 10 de abril de 2026 12:33:28 UTC
- Conteúdo coletado em: 2026-09-14T14:55:05.806Z
- SHA-256 semântico: `e5c2fd8f14b66aebf9128945a005f6ca2d408b37272c924c1dec2e141ff6fefb`
