---
key: "REGIMEAPURACAO.CONSULTARRESOLUCAO104"
family: "integra-sn"
systemId: "REGIMEAPURACAO"
serviceId: "CONSULTARRESOLUCAO104"
version: "1.0"
...
| Propriedade | Valor |
| --- | --- |
| Chave | `REGIMEAPURACAO.CONSULTARRESOLUCAO104` |
| Família | `integra-sn` |
...
| --- | --- | --- | --- | --- | --- |
| Dados de Entrada — Objeto Dados: | anoCalendario | Number | SIM | — | Ano |
...
| Dados de Saída — Objeto: RegimeApuracao | textoResolucao | String | — | — | Texto fixo da resolução pelo Regime de Caixa em base 64 |
...
- [Documentação oficial SERPRO](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-sn/regime/servicos/consultar_resolucao/)
- [Documentação oficial SERPRO](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-sn/regime/exemplos/retorno_consultar_resolucao/)

- Última atualização informada pela fonte: 10 de abril de 2026 12:33:28 UTC
- Conteúdo coletado em: 2026-09-14T14:55:05.806Z
- SHA-256 semântico: `6086ccb971fc02275dbf623924b2e3fc6ece5f027bea3a1eb13be1411811b0f2`
