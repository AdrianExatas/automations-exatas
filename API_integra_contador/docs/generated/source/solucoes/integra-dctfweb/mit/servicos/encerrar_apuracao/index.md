---
source: "https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-dctfweb/mit/servicos/encerrar_apuracao/"
sourceUpdatedAt: "10 de abril de 2026 14:58:42 UTC"
retrievedAt: "2026-09-14T14:50:27.826Z"
semanticHash: "ff5f076257b05459e374a59f4b143b03d114b9a0d792b29bafc57175a1890c89"
generated: true
---

> Conteúdo normalizado automaticamente a partir da documentação oficial. Em caso de dúvida, prevalece a [fonte SERPRO](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-dctfweb/mit/servicos/encerrar_apuracao/).

# Encerrar apuração

Este serviço inicia o serviço de encerramento de uma apuração do Módulo Inserção de Tributos do sistema DCTFWeb.

A apuração NÃO será enviada à DCTFWEB no momento da requisição. O envio será feito automaticamente em momento posterior.

Utilize o serviço [Consultar Situação Encerramento](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-dctfweb/mit/servicos/consultar_situacao_encerramento/) gratuitamente passando o protocoloEncerramento devolvido neste serviço para consultar o status do envio.

Identificação no Pedido de Dados

idSistema: MIT idServico: ENCAPURACAO314
...
| Campo | Descrição | Tipo |
| --- | --- | --- |
| protocoloEncerramento | Protocolo de encerramento da apuração. | String |
| idApuracao | Identificador da apuração criada. | Number |
...
**a) Se recebi o httpStatusCode 200 significa que a apuração foi enviada à DCTFWEB?**

Verifique se o código retornado é o MSG_0024. Se for, a apuração foi aceita pelo MIT e está em processo de envio à DCTFWEB.

**b) Como faço para saber se a apuração se encontra na DCTFWEB?**

Utilize o serviço [Consultar Situação Encerramento](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-dctfweb/mit/servicos/consultar_situacao_encerramento/) gratuitamente passando o protocoloEncerramento devolvido neste serviço Encerrar Apuração para consultar o status do envio.

**c) Se o status estiver "ENCERRAMENTO_EM_CURSO", o que devo fazer?**

Aguarde. Em momentos de grande utilização, este processo pode demorar alguns minutos.

**d) Por que recebi a MSG_0024 mas ao consultar a situação está "EM_EDIÇÃO"?**

A DCTFWEB, em algumas situações específicas, recusa a apuração. O motivo está no AvisosDctf contidos no serviço [Consultar Situação Encerramento](https://apicenter.estaleiro.serpro.gov.br/documentacao/api-integra-contador/pt/solucoes/integra-dctfweb/mit/servicos/consultar_situacao_encerramento/)

Atenção

**Caso exista uma apuração em edição no mesmo período, esta será sobrescrita com a apuração sendo enviada.**
