...
export function readEmpresas(excelPath: string): Empresa[] {
  ...
  const onvioClientSourceColumn = findColumn(columns, ["onvio_client_source", "client source"]);
  ...
  for (const row of data) {
    ...
    const empresa: Empresa = {
      ...
      onvioClientSource: readOptionalString(row, onvioClientSourceColumn) || undefined,
